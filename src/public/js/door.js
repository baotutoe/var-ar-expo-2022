...
ic_showroom_1 = new PANOLENS.Tile(21, 9);
PANOLENS.Utils.TextureLoader.load("static/images/mt.png", setClampTexture.bind(ic_showroom_1));
ic_showroom_1.position.set(-50, -20, -75);
ic_showroom_1.scale.set(1, 1.5, 1)
ic_showroom_1.rotation.set(-0.5, 0, 0)
